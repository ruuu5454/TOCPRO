...
# from messageTemplate import mainMenu, actionMenu, expenseTypeMenu, incomeTypeMenu, checkMenu
...
#         reply_token, FlexSendMessage("收支選單", actionMenu))
#     return "OK"
...
#     line_bot_api = LineBotApi(channel_access_token)
#     line_bot_api.reply_message(
#         reply_token, FlexSendMessage("支出種類選單", expenseTypeMenu))
#     return "OK"


# def send_income_type_menu(reply_token):
#     line_bot_api = LineBotApi(channel_access_token)
#     line_bot_api.reply_message(
#         reply_token, FlexSendMessage("收入種類選單", incomeTypeMenu))
#     return "OK"
...
#     line_bot_api = LineBotApi(channel_access_token)
#     line_bot_api.reply_message(
#         reply_token, FlexSendMessage("查詢選單", checkMenu()))
#     return "OK"
